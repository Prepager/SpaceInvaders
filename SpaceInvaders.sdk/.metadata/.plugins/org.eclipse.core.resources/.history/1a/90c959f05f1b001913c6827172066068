...
void initializeShield(Shield *shield) {
	// Allocate space for shield block and corners.
	shield->blocks = malloc(sizeof(ShieldBlock) * SHIELD_BLOCK_COUNT);
	shield->corners = malloc(sizeof(ShieldCorner) * SHIELD_CORNER_COUNT);
