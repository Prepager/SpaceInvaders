...
HD_PWD='C:/Users/shuha/OneDrive/Skrivebord/Kurser/3.Semester/3 Ugers Projekt/Zip filer/Spaceinvaders/Spaceinvaders.runs/hdmi_in_v_tc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_in_v_tc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_in_v_tc_0_0.tcl
